...
**Application Outcomes 1% call-out (Diana, 2026-09-08; SSI benefit 2026-09-09; student per-person 2026-09-09; title 2026-09-09):** a simpler current-era cousin of the Approval Rate estimator, not the max-vs-average table. Headed **What is the impact of procedural denials?** On Application Trends: 1% of applications disposed in the last month of the date range, for the selected place, as additional cases. All applications × California average issuance **per household** (Total Issuances ÷ CalFresh Households; if that month is missing, the latest month at or before it). College students × California average issuance **per person** (Total Issuances ÷ CalFresh Persons) — CDSS does not publish a student-specific issuance, and many student households are likely one person. SSI households × Monthly `Average Approved Benefit - SSI` (newly approved some-SSI households, the same population as the SSI outcomes mix; fall back to the all-household rate if missing). One month of benefits. The household may or may not have been eligible.
